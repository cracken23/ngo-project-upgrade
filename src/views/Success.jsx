...
const Success = () => {
  ...
  return (
    <div className="tw-min-h-[80vh] tw-flex tw-flex-col tw-items-center tw-justify-center tw-p-6 tw-bg-gradient-to-br tw-from-[#f8f9fa] tw-to-[#f1f1f1]">
      <Helmet>
      ...
      <div className="tw-max-w-2xl tw-mx-auto tw-bg-white tw-p-10 tw-rounded-2xl tw-shadow-xl tw-text-center tw-animate-fade-in">
        <div className="tw-mb-8">
          ...
          <div className="tw-w-16 tw-h-16 tw-bg-[#4CCD99]/10 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-mx-auto tw-mb-6">
        ...
        <h1 className="tw-text-4xl tw-font-bold tw-mb-4 tw-font-playfair tw-text-[#e59d76]">Thank You For Your Donation!</h1>
        
        <p className="tw-text-xl tw-mb-8 tw-text-neutral-medium">
        ...
        <div className="tw-space-y-4">
          <button 
            ...
            className="tw-bg-[#e59d76] hover:tw-bg-[#d48a63] tw-text-white tw-font-bold tw-py-3 tw-px-8 tw-rounded-lg tw-shadow-lg tw-transition-all tw-duration-300"
          >
            Return to Home
          </button>
          
          <p className="tw-text-neutral-medium tw-mt-4">
